...
namespace Maliev.EmployeeService.Infrastructure.Migrations
{
    ...
    [Migration("20251012030758_AddDepartmentEntity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Maliev.EmployeeService.Domain.Entities.LeaveRequest", b =>
                {
                    ...
                    b.HasIndex("CurrentApproverId")
                        .HasDatabaseName("i_x_leave_requests_current_approver_id");
            ...
            modelBuilder.Entity("Maliev.EmployeeService.Domain.Entities.LeaveRequest", b =>
                {
                    b.HasOne("Maliev.EmployeeService.Domain.Entities.Employee", "CurrentApprover")
                        .WithMany()
                        .HasForeignKey("CurrentApproverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("f_k_leave_requests_employees_current_approver_id");
