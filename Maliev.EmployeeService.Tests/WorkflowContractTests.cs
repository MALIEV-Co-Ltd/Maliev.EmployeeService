...
namespace Maliev.EmployeeService.Tests;
...
public sealed class WorkflowContractTests
{
    ...
    private static string FindRoot()
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "Maliev.EmployeeService.sln")))
            {
                return directory.FullName;
            }
        }
        throw new DirectoryNotFoundException("Could not locate EmployeeService repository root.");
    }
}
